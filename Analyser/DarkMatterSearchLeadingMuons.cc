...
void DarkMatterSearchLeadingMuons(string year, vector<string> const& fileNames, string const& outputFileNameTree = "TTreeOutput.root",const Int_t nevt_max = 100)
{ 
...
int main(int argc, char** argv)
{
  ...
  DarkMatterSearchLeadingMuons(year_str, allnamesWithPrefixFinal, filenameTree, maxevent);
